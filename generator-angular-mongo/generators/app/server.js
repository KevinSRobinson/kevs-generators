...
module.exports.generate = function (data, runner, basepath) {
  ...
  //Core Files
  copier.copyTpl(runner, _srcPath + '_app.js', basepath + 'app.js', data);
  copier.copyTpl(runner, _srcPath + '_package.json', basepath + 'package.json', data);
